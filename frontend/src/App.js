...
// RPS app
const appIndex = 177175135;
const appAddress = "GKWVWIFULYG4JI7U5CTITSBPJJM2VFEOYH3GOW5BT7QXRR35D2HVO4G4ZU";
...
function App() {
  ...
  async function startRpsApplication(
    ...
    try {
      ...
      const accounts = [
        "H5RXOF74HPIJB7TGLCD7WQVTV7DF6TGMQJI7KADLM4ABLL2JB6O45M2MKE",
      ];
  ...
  async function joinRpsApplication(sum) {
    try {
      ...
      const accounts = [
        "6V3UCDD7QWN24JLBW6CPBICX7FCWTN3744ENDZL2UP2FVXNKSS5HX32ASM",
      ];
